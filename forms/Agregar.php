...
<body>
  <h1 class="bg-info p-2 text-white text-center"> Agendar Cita  <i class="fa-solid fa-calendar-check"></i></h1>
  <br>
  ...
  <div class="container">
    <form action="../CRUD/Insertar.php" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="tel" class="form-control" name="numero" pattern="[0-9]{10}" required>
